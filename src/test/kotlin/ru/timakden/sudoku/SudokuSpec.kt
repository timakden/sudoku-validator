...
class SudokuSpec : FunSpec({
    context("SudokuSolutionExtractor") {
        test("extract solution from file") {
        ...
        test("throw exception when file couldn't be opened") {
        ...
        test("throw exception when file contains invalid number of lines") {
        ...
        test("throw exception when file contains invalid data") {
    ...
    context("SudokuValidator") {
        ...
        test("throw exception when solution contains duplicates in a row") {
            val solution = listOf(
                listOf(4, 3, 5, 2, 6, 9, 7, 8, 1),
                listOf(6, 8, 2, 5, 7, 1, 4, 9, 3),
        ...
        test("throw exception when solution contains duplicates in a column") {
            val solution = listOf(
                listOf(4, 3, 5, 2, 6, 9, 7, 8, 1),
                listOf(6, 8, 2, 5, 7, 1, 4, 9, 3),
                listOf(1, 9, 7, 8, 3, 4, 5, 6, 2),
        ...
        test("throw exception when solution contains duplicates in a 3x3 square") {
            val solution = listOf(
